 ...
 * @typedef  {ContainerGroupStartupProbe} containerGroupStartupProbe - Represents the container group startup probe - Represents the container group startup probe
