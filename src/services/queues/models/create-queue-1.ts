 ...
 */
export const createQueue1 = z.lazy(() => {
  return z.object({
    name: z
      .string()
      .min(2)
 ...
 * @typedef  {CreateQueue1} createQueue1 - Represents a request to create a new queue. - Represents a request to create a new queue.
 ...
 */
export type CreateQueue1 = z.infer<typeof createQueue1>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const createQueue1Response = z.lazy(() => {
  return z
    .object({
      name: z
        .string()
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const createQueue1Request = z.lazy(() => {
  return z
