...
/**
 * Zod schema for the ContainerConfigurationLogging model.
...
/**
 * Zod schema for mapping API responses to the ContainerConfigurationLogging application shape.
...
/**
 * Zod schema for mapping the ContainerConfigurationLogging application shape to API requests.
