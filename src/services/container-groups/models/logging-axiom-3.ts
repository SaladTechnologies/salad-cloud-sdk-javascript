 ...
 */
export const loggingAxiom3 = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {LoggingAxiom3} loggingAxiom3
 * @property {string}
 * @property {string}
 * @property {string}
 */
export type LoggingAxiom3 = z.infer<typeof loggingAxiom3>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const loggingAxiom3Response = z.lazy(() => {
  return z
    .object({
      host: z.string().min(1).max(1000),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const loggingAxiom3Request = z.lazy(() => {
  return z
