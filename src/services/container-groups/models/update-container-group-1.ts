 ...
 */
export const updateContainerGroup1 = z.lazy(() => {
  return z.object({
    displayName: z
      .string()
      .min(2)
 ...
 * @typedef  {UpdateContainerGroup1} updateContainerGroup1 - Represents a request to update a container group - Represents a request to update a container group
 * @property {string}
 ...
 */
export type UpdateContainerGroup1 = z.infer<typeof updateContainerGroup1>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const updateContainerGroup1Response = z.lazy(() => {
  return z
    .object({
      display_name: z
        .string()
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const updateContainerGroup1Request = z.lazy(() => {
  return z
    .object({
