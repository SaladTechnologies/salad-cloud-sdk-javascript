 ...
 */
export const createContainerGroup1 = z.lazy(() => {
  return z.object({
    name: z
      .string()
      .min(2)
 ...
 * @typedef  {CreateContainerGroup1} createContainerGroup1 - Represents a request to create a container group - Represents a request to create a container group
 * @property {string}
 * @property {string}
 ...
 */
export type CreateContainerGroup1 = z.infer<typeof createContainerGroup1>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const createContainerGroup1Response = z.lazy(() => {
  return z
    .object({
      name: z
        .string()
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const createContainerGroup1Request = z.lazy(() => {
  return z
    .object({
