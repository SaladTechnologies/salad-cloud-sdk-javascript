...
| storageAmount | number   | ❌       | The amount of storage to allocate to the container in bytes (between 1GB and 250GB).         |
| shmSize       | number   | ❌       | The size of the shared memory (/dev/shm) in MB. If not specified, defaults to 64MB.          |
